    ...
    createHandler = (e) => {
        ...
        RestClient.PostRequest(`${AppUrl.BaseURL}/appointments`, data, true).then(response => {
            ...
            if(response.validation.status){
                ...
                //console.log('reset'); //buggy using reset...
            }
        });
    }
                        ...
                        <div className="col-12">
                          ...
                          <form id="createForm" onSubmit={this.createHandler}>
                              ...
                              <div className="mb-3">
                                  ...
                                  <textarea name="appointment_comment" className="form-control u-height-150" value={this.state.appointment_comment} onChange={(e)=>{this.setState({appointment_comment:e.target.value})}} ></textarea>
                              </div>
