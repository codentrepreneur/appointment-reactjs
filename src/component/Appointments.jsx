    ...
    render(){
        ...
        */
        ...
        const allAppointments = appointments.map((appointment, idx)=>{
            ...
            */
            if(
                (Auth.isScheduler()) || // Allow if Scheduler, could not change status if no assigned doctor...
                (Auth.isDoctor()&&appointment.did === parseInt(localStorage.getItem('userID'))) // Allow doctor update status assigned to them...
            ){
                appUpdateStatus = (
