    ...
    render(){
        ...
        */
        ...
        const allAppointments = appointments.map((appointment, idx)=>{
            ...
            // Update Status...
            if(  (Auth.isScheduler() || appointment.did === parseInt(localStorage.getItem('userID'))) // Allow if Scheduler or Assigned Doctor
                && (appointment.status !== 'Accepted' || appointment.did === parseInt(localStorage.getItem('userID')) )  // Disable if status is Accepted...
